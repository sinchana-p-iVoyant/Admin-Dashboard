...
const Sidebar = () => {
  ...
  return (
    <div className='sidebar-container' style={{ backgroundColor: darkTheme ? "#1f2a40" : "#DDE6ED", color: darkTheme ? "#DDE6ED" : "#27374d", padding: isCollapsed ? "0 14px" : "0" }}>
      ...
      <Sider trigger={null} collapsible collapsed={isCollapsed}>
        ...
        <div className="admins-container"  style={{ backgroundColor: darkTheme ? "#1f2a40" : "#DDE6ED", color: darkTheme ? "#DDE6ED" : "#27374D"  }}>
