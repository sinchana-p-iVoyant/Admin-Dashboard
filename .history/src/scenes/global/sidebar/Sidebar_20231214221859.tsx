...
const Sidebar = () => {
  ...
  return (
    <div className='sidebar-container' style={{  minWidth: '255px', backgroundColor: darkTheme ? "#27374D" : "#DDE6ED", color: darkTheme ? "#DDE6ED" : "#27374d", padding: isCollapsed ? "0 14px" : "0" }}>
